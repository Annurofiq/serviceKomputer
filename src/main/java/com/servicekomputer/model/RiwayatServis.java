...
public class RiwayatServis {
    ...
    private String dihapusPada;

    public RiwayatServis() {}

    public RiwayatServis(String idServis, String idPelanggan, String namaPelanggan,
                         String idTeknisi, String namaTeknisi, String jenisPerangkat,
                         String merk, String kerusakan, double biaya,
    ...
    public String getDihapusPada() { return dihapusPada; }
    public void setDihapusPada(String dihapusPada) { this.dihapusPada = dihapusPada; }
}